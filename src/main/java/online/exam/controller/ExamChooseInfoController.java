...
public class ExamChooseInfoController {
    ...
    public void examChooseHandler(
        ...
        //------------日志
        System.out.println("考生 " + studentId + " 在试卷 " + examPaperId + " 中试题 " + subjectId + " 选择了答案 " + chooseAswer + " 序号 " + index);
        ...
        //------------日志
        System.out.println("考生是否选择过试题 " + subjectId + " " + examChoose + " (NULL-否)");
        if (examChoose == null) {
            //------------日志
            System.out.println("考生 " + studentId + " 尚未选择试题 " + subjectId + " 添加选择记录 答案 " + chooseAswer);
            map.put("chooseResult", chooseAswer);
            /** 添加选择记录 */
            examChooseInfoService.addChoose(map);
        } else if (examChoose.getChooseId() != null && examChoose != null) {
            //------------日志
            System.out.println("考生 " + studentId + " 已经选择试题 " + subjectId + " 修改选择记录 答案 " + examChoose.getChooseResult() + " 更新为 " + chooseAswer);
            /*
            ...
            if (!chooseAswer.equals(examChoose.getChooseResult())) {
                ...
                //------------日志
                System.out.println("考生选择了相同答案，不做修改操作");
            }
        } else {
