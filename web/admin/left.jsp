...
<body id="bg">
	...
	<div class="container">
		<div class="leftsidebar_box">
			...
			<dl class="system_log">
				<dt>基本信息<img src="${path }/images/left/select_xl01.png" /></dt>
			...
			<dl class="custom">
				<dt>班级管理<img src="${path }/images/left/select_xl01.png" /></dt>
			...
			<dl class="custom">
				<dt>教师管理<img src="${path }/images/left/select_xl01.png" /></dt>
			...
			<dl class="app">
				<dt>试卷管理<img src="${path }/images/left/select_xl01.png" /></dt>
